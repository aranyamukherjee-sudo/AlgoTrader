...
base = Path("data/src/main/kotlin/com/algotrader/data")
base.mkdir(parents=True, exist_ok=True)

files = {
    "SyntheticMarketDataGenerator.kt": """package com.algotrader.data
...
print("Synthetic market-data generator created.")
